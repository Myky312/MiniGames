...
var firstImager = "images/dice" + randomNumber1 + ".png";
var secondImager = "images/dice" + randomNumber2 + ".png";
var firstImage = document.querySelectorAll("img")[0];
var secondImage = document.querySelectorAll("img")[1];
firstImage.setAttribute("src", firstImager);
secondImage.setAttribute("src", secondImager);
